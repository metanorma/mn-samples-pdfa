...
[cols="a,a,a"]
|===
h| `PDF/mail-1` Profile h| `PDF/A` Conformance Levels h| Description
...
(see <<ISO_3200_2,clause=12.3.5>>). `PDF/A` standards do [underline]#_not_# define
